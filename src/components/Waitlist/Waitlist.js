                    ...
                    <div className="padding-section-large">
                        <div className="waitlist-wrapper">
                            <div className="waitlist-wrapper-left max-width-large">
                                ...
                                <h3 className="heading-style-h3 margin-bottom margin-medium">
                                    {waitlistItems.head1}
                                </h3>
                                <div className="w-form">
                                    {isShown && (
                                        <div
                                            className="sendgrid-subscription-widget widget-2368"
                                            data-emailerror="Please enter a valid email address"
                                        >
                                            <form
                                                onSubmit={HandleSubmit}
                                                data-token="0719662e9bb0cc2768bc17f2c5cfb745"
                                                id="email-form"
                                                name="email-form"
                                    ...
                                    {!isShown && (
                                        <div className="w-form-done">{waitlistItems.received}</div>
                                    )}
                                ...
                                <div className="text-size-small">
                                    ...
                                    <a
                                        target="_blank"
                                        rel="noreferrer"
                                        href={waitlistItems.terms}
                                        className="link"
                                    >
                                        Terms of Service
                                    </a>
                                    &nbsp; and provide consent to receive marketing communication
                                    and emails for special offers
                                </div>
                            </div>
                            <div className="waitlist-wrapper-right max-width-medium max-width-full-tablet">
                                <div className="waitlist-benefit-wrapper margin-vertical margin-medium">
                                    <div className="icon-wrapper-48">
                                        <img
                                            src="/images/icn-takepart.svg"
                                            loading="lazy"
                                            alt="take part"
                                        ></img>
                                    </div>
                                    <p className="text-size-medium">{waitlistItems.paragraph1}</p>
                                </div>
                                <div className="waitlist-benefit-wrapper margin-vertical margin-medium">
                                    <div className="icon-wrapper-48">
                                        <img
                                            src="/images/icn-starwithcheckmark.svg"
                                            loading="lazy"
                                            alt="starwithcheckmark"
                                        ></img>
                                    </div>
                                    <p className="text-size-medium">{waitlistItems.paragraph2}</p>
                                </div>
                            </div>
                        </div>
                    </div>
