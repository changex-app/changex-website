                ...
                <div className="container-large">
                    <div className="padding-section-large is-cta-section">
                        <div className="max-width-medium">
                            <div>
                                <h2 className="heading-style-h2 highlight is-white">
                                    Get <span className="highlight is-white">Changex</span>
                                    <br />
                                    Earn Freedom
                                </h2>
                                <p className="is-white text-size-large margin-vertical margin-large">
                                    Manage, invest, and grow your wealth with a Euro bank account,
                                    access to crypto, and DeFi investment tools.
                                </p>
                            </div>
                            <div className="button-group centered-items margin-top margin-large spread align-left">
                                ...
                                >
                                    <img
                                        src="/images/cta/DW%20Google.svg"
                                        loading="lazy"
                                        width="150"
                        ...
                        <div className="cta-image">
                            <StaticImage
                                src={"../../../static/images/cta/image_cta.png"}
                                alt={"cta"}
                            ></StaticImage>
                            <button
                                onClick={openModal}
